...
class DevToolsConnection extends eventEmitter.EventEmitter {
...
class StoreDevTools extends eventEmitter.EventEmitter {
  constructor(config = {}) {
    super();
...
exports.DevToolsConnection = DevToolsConnection;
exports.StoreDevTools = StoreDevTools;
exports.VisualInspector = VisualInspector;
