...
class ReactiveOptimizer {
  ...
  createOptimizedReactive(target) {
    ...
    const proxy = vue.reactive(target);
  ...
  createShallowReactive(value) {
    const ref = vue.shallowRef(value);
    return {
      value: ref.value,
      setValue(newValue) {
        ref.value = newValue;
...
exports.ComputedOptimizer = ComputedOptimizer;
exports.DependencyTracker = DependencyTracker;
exports.MemoryManager = MemoryManager;
exports.ReactiveOptimizer = ReactiveOptimizer;
exports.SmartCacheManager = SmartCacheManager;
exports.VirtualProxy = VirtualProxy;
exports.batchUpdate = batchUpdate;
exports.batchUpdateManager = batchUpdateManager;
exports.batchUpdateSync = batchUpdateSync;
exports.dependencyTracker = dependencyTracker;
exports.memoryManager = memoryManager;
exports.reactiveOptimizer = reactiveOptimizer;
exports.waitForUpdates = waitForUpdates;
//# sourceMappingURL=ReactiveSystem.cjs.map
