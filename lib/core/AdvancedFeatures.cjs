...
class SnapshotManager {
  ...
  create(name, metadata, tags) {
    ...
    const snapshot = {
      id,
      name,
      state: JSON.parse(JSON.stringify(vue.toRaw(this.store.$state))),
      metadata: metadata || {},
      timestamp: Date.now(),
      tags
    };
...
exports.MiddlewareSystem = MiddlewareSystem;
...
exports.createMiddlewareSystem = createMiddlewareSystem;
//# sourceMappingURL=AdvancedFeatures.cjs.map
