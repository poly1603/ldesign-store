...
class PerformanceMonitor extends eventEmitter.EventEmitter {
  constructor(options = {}) {
    super();
...
exports.AutoPerformanceAnalyzer = AutoPerformanceAnalyzer;
...
//# sourceMappingURL=PerformanceMonitoring.cjs.map
