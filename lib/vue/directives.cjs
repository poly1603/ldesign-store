...
const vStore = {
  mounted(el, binding) {
    ...
    const storeId = arg;
    const store = helpers.globalStoreManager.get(storeId);
    if (!store) {
...
exports.createStoreDirectivesPlugin = createStoreDirectivesPlugin;
exports.storeDirectives = storeDirectives;
exports.vAction = vAction;
