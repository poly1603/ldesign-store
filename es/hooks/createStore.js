...
import { reactive, computed, ref, watch, shallowRef } from 'vue';
  ...
  const storeDefinition = defineStore(id, () => {
    ...
    Object.entries(getters).forEach(([key, getter]) => {
      if (typeof getter === "function") {
        computedGetters[key] = computed(() => getter(reactiveState));
      }
    });
    return {
      ...reactiveState,
...
export { createAsyncAction, createComputed, createPersistedState, createState, createStore };
